...
class ProfessorTest {
    ...
    class Describe_compileStatistics {
        ...
        @Nested
        @DisplayName("다익스트라 교수의 알고리즘 Lecture")
        class Context_with_dijkstra {
            ...
            void it_returns_statistics() {
                ...
                Assertions.assertThat(result).isEqualTo("[다익스트라] Pass: 3 Fail: 2 - Avg: 69.2");
            }
        }

        @Nested
        @DisplayName("다익스트라 교수의 알고리즘 GradeLecture")
        class Context_with_dijkstra_grade_lecture {
            ...
            void it_returns_statistics() {
                ...
                Assertions.assertThat(result).isEqualTo("[다익스트라] Pass: 3 Fail: 2, A:1 B:1 C:1 D:1 F:1 - Avg: 69.2");
            }
        }
    }
